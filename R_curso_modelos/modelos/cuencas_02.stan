...
parameters {
  ...
  // Hiperparámetros: media y desvío de cada uno
  real log_a_mu;
  real log_l_mu;
  real log_k_mu;
  real log_phi_mu;
...
transformed parameters {
  // Verdadero parámetros a nivel de cuenca, no estandarizados, en log
  vector[nc] log_a = log_a_raw * log_a_sd + log_a_mu;
  vector[nc] log_l = log_l_raw * log_l_sd + log_l_mu;
  vector[nc] log_k = log_k_raw * log_k_sd + log_k_mu;
  vector[nc] log_phi = log_phi_raw * log_phi_sd + log_phi_mu;
